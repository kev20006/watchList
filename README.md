...
Wireframes are included below with a brief discussion about each. Alternatively, you can view the wireframe in the documentation folder found here.
...
##### 1. Manually Having to Referesh The Page when items were added {#bug-fix-1}
...
#### 2. Frequent Annoying Pop-Up {#bug-fix-2}
...
##### 3. Frequently Exceeeding API Request Limit {#bug-fix-3}
...
##### 4. Pagination Controls Not Working Correctly {#bug-fix-4}
...
##### 5. View more information generates a new movie item each time it is clicked {#bug-fix-5}
...
##### 6 .Episode tracker doesn't work if a series doesn't have specials {#bug-fix-6}
...
##### 7. Tags with deleted content persist on refresh. {#bug-fix-7}
...
##### 8. Drawer Menu was longer than viewport. {#bug-fix-8}
